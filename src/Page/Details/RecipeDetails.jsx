...
const RecipeDetails = () => {
    ...
    return (
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10  mx-auto">

        {
            recipeLoader.map(recipe => <div key={recipe._id}>

<div className="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
    <img className="object-cover w-full h-64" src={recipe.strMealThumb} alt="Article"/>

    <div className="p-6">
        <div>
            <span className="text-xs font-medium text-blue-600 uppercase dark:text-blue-400">{recipe.strMeal}</span>
